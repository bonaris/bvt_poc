...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_type', help='specific test type bvt/e2e')

    args = parser.parse_args()

    TestExecutor.run_tests(testcase_class=args.tc, browser=args.browser, mode=args.mode, test_type=args.test_type)
